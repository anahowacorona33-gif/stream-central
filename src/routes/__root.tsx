...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "IPTVs Anbieter mit über 20.000 Live-Sendern, 145.000+ Filmen und 44.000+ Serien in 4K UHD. €45/Jahr, 30 Tage Geld-zurück, sofortige Aktivierung." },
      ...
      { property: "og:description", content: "IPTVs Anbieter: 20.000+ Sender, 145.000+ Filme, 44.000+ Serien. Nur €45/Jahr." },
