...
const BREADCRUMB_JSONLD = breadcrumbJsonLd([
  ...
  { name: "12 Monate Abo", path: "/abonnement-12-monate" },
]);

export const Route = createFileRoute("/abonnement-12-monate")({
  head: () => ({
    meta: [
      { title: "IPTV Anbieter – IPTV Abo 12 Monate für €45" },
      { name: "description", content: "Beliebtester Tarif beim IPTV Anbieter: 12 Monate für €45 – nur €3,75/Monat. 20.000+ Live-Sender, 4K UHD, kein Vertrag, 30 Tage Geld-zurück." },
      { property: "og:title", content: "IPTV Anbieter – 12 Monate Abo für €45 (Beliebt)" },
      { property: "og:description", content: "Unser beliebtester Tarif: 12 Monate Premium IPTV Anbieter für nur €45." },
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 md:py-24">
      <div className="text-center">
        ...
        <h1 className="mt-4 font-display text-5xl md:text-7xl">IPTV Anbieter – 12 Monate Abo für €45</h1>
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Ein ganzes Jahr beim Premium-IPTV Anbieter für nur €45 – das entspricht €3,75 pro Monat. 20.000+ Live-Sender, 145.000+ Filme, 44.000+ Serien in 4K UHD.
        </p>
      </div>
      <div className="mt-10">
        <PricingTabs />
