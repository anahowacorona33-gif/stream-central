  ...
  return (
    <section className="mx-auto max-w-5xl px-4 pb-20">
      ...
      <div className="space-y-6">
        {/* 1 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV Anbieter in Deutschland</h2>
        ...
        {/* 2 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">Installation IPTV auf Smart TV</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 3 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV auf dem Fire TV Stick</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 4 — table */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV in 4K UHD – Bandbreite und Codecs</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 5 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV Sport – Bundesliga, Champions League und mehr</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 6 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV VOD – Filme und Serien on Demand</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 7 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV Multi-View – vier Streams gleichzeitig</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 8 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV Anti-Freeze – stabile Wiedergabe ohne Ruckeln</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 9 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV auf Android TV und Apple TV</h2>
          <p className="mt-3 text-foreground/90">
        ...
        {/* 10 */}
        <article className="rounded-lg border border-border/60 bg-card/40 p-6">
          <h2 className="font-display text-2xl">IPTV International – Sender aus aller Welt</h2>
          <p className="mt-3 text-foreground/90">
